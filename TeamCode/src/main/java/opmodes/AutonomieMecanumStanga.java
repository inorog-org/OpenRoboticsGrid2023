...
@Autonomous(name="AutoStangaEficient", group="Linear Opmode")
public class AutonomieMecanumStanga extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            strafeLeft(28, 0.4); // pozitionare centrala fata de zona depunere
            rotate(-45, 0.4);
            driveForward(60, 0.4);
